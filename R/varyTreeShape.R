#' Calculate alpha or beta metrics across a set of parameters, with varying tree shapes
#'
#' Takes a specified set of tree size, community richness, and a vector of abundances, and
#' takes a list of deltas, and calculates the community structure metrics.
#'
